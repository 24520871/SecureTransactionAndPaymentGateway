...
import CheckoutForm
from "@/components/payment/CheckoutForm";
...
function CheckoutContent() {
  ...
  // 1. Lấy sản phẩm dựa trên ID từ URL
  // (mặc định lấy món đầu tiên nếu URL trống)
  const product =
    products.find(
          ...
          <div className="bg-white p-6 rounded-2xl border shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Nguyễn Lâm Minh Khoa"
          ...
          <div className="bg-white p-6 rounded-2xl border shadow-sm">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button
                    ...
                    className="w-8 h-8 border rounded-lg hover:bg-gray-100 font-bold"
                  >
                    -
                  </button>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <label
                  className={`border p-3 rounded-xl flex flex-col cursor-pointer ${
